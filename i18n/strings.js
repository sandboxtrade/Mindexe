...
export const STRINGS = {
  ru: {
    ...
    home: {
      ...
      insightConfident: "Пока в журнале нет достаточно устойчивой связи между состоянием, поведением и результатом, чтобы делать полезный вывод.",
      insightFocus: "Пока данных мало. Добавь ещё несколько завершённых сделок — приложение не будет придумывать инсайт из слабой выборки.",
      moodCalm: "\u0421\u043F\u043E\u043A\u043E\u0439\u043D\u043E\u0435",
  ...
  en: {
    ...
    home: {
      ...
      insightConfident: "There is not enough stable evidence yet to show a useful relationship between state, behavior, and outcome.",
      insightFocus: "There is still too little data. Add a few more closed trades; the app will not manufacture an insight from a weak sample.",
      moodCalm: "Calm",
      moodStable: "Stable",
