...
import {
  ...
  formatStrategyTotal, normalizeResultCurrency, normalizeResultMode, unitSymbol
...
import { BASE, WIN, LOSS, INSTRUMENTS } from "../../config/app-config.js";
import { Card, Pill, ScreenshotImage, EmptyState, StatCard } from "../../ui/primitives.js";
import { LogoSpinner } from "../../ui/brand.js";
import { compressImageFile } from "../../ui/media-utils.js";
import { PickerField } from "../journal/journal-ui.js";
import { aiAnalyzeStrategy, aiRecognizeTradeFromImage } from "../../ai/trade-tools.js";
...
function StrategyTradeForm({ strategy, accent, customInstruments, onAddCustomInstrument, notify, lang, onCancel, onSave }) {
  ...
  const handleRecognizeFile = async (e) => {
    ...
    try {
      ...
      if (rec.uncertainFields?.length) notify?.(isEn ? "Some values were uncertain — verify them manually" : "Часть значений распознана неуверенно — проверь их вручную");
