...
// V5.2: the splash is now the user-supplied 5.9s black-hole video (720x1556 h264, ~1.3 MB) instead
// of the still photo plus the canvas starfield/candlestick simulation that stood in for it. The
// video ships as a sibling file next to index.html, NOT base64-inlined \u2014 inlining would add ~1.8 MB
// to every app.js download and defeat browser caching of an asset that never changes.
// SPLASH_BLACKHOLE_IMG is kept as the poster: it shows instantly while the video buffers and remains
